...
config.TILT_MAX_ANGLE      = 45   -- ângulo máximo dos tilt adapters (graus)
config.TILT_STEP           = 5    -- incremento de ângulo por comando (graus)
config.THROTTLE_STEP       = 1    -- incremento de throttle por comando

-- === LADOS DE REDSTONE ===
-- Lados do computador que controlam componentes via redstone
config.THRUSTER_SIDE       = "back"    -- lado que controla o thruster principal
config.DETONACAO_SIDE      = "top"     -- lado que ativa a detonação
